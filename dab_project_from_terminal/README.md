# dab_project_from_terminal

The 'dab_project_from_terminal' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/dab_project_from_terminal/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] dab_project_from_terminal_etl` to your workspace.
